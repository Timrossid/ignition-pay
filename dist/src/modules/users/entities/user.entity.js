...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.deletedAt = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _deletedAt_initializers, void 0));
    ...
    (() => {
        ...
        _deletedAt_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.DeleteDateColumn)({ type: 'timestamp', nullable: true })];
