...
let WebhookSignatureGuard = class WebhookSignatureGuard {
    ...
    canActivate(context) {
        ...
        const webhookSecret = this.configService.get('KYC_WEBHOOK_SECRET');
        if (!signature || !webhookSecret) {
            throw new common_1.UnauthorizedException('Missing signature or webhook secret configuration');
        }
